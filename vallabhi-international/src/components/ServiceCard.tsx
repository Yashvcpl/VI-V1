...
export function ServiceCard({ title, description, href, icon, iconUrl, buttonText, buttonLink }: ServiceCardProps) {
  ...
  return (
    <article className="group rounded-[28px] border border-ledger/10 bg-paper p-8 text-left shadow-[0_20px_60px_-35px_rgba(16,48,80,0.18)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_90px_-35px_rgba(16,48,80,0.3)]">
